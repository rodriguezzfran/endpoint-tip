...
TEST(DialogueTest, MockDialogueOne) {
    ...
    EXPECT_CALL(mockDialogueOne, ResponseHello())
        .Times(Exactly(1));
    EXPECT_CALL(mockDialogueOne, sayHowAreYou())
        .Times(Exactly(1));
...
TEST(DialogueTest, MockDialogueTwo) {
    ...
    EXPECT_CALL(mockDialogueTwo, sayHello())
        .Times(Exactly(1));
    EXPECT_CALL(mockDialogueTwo, sayFineAndYou())
        .Times(Exactly(1));
